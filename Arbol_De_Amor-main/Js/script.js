...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para el amor de mi vida:\n\nHola amor, estos 365 dias han sido los mas bonitos, felices, emos tenido pros y contras,\n\npero cada momento a tu lado son los mas bellos aun sean pequeños y grandes.\n\n me han enseñado lo que es querer de verdad compartir la vida y encontrar en otra persona mi lugar favorito en el mundo.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, tu Missa";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-05-17T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2027-05-17T00:00:00');
